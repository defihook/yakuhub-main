...
export async function getOrCreateAssociatedTokenAccount(
    ...
    if (!account.mint.equals(mint.toBuffer() as unknown as PublicKey)) throw Error('TokenInvalidMintError');
    if (!account.owner.equals(owner.toBuffer() as unknown as PublicKey)) throw new Error('TokenInvalidOwnerError');
