...
import { Card, CardContent, CardHeader, Divider, Typography, CardProps, CardContentProps } from '@mui/material';
    ...
    (
        ...
        return (
            ...
            >
                ...
                {/* card content */}
                {content && <CardContent sx={{ ...contentSX, p: { xs: 0, md: '24px' } }}>{children}</CardContent>}
                {!content && children}
            </Card>
        );
    }
