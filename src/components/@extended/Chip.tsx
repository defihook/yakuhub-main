...
const Chip = ({ chipcolor, disabled, sx = {}, variant, ...others }: CustomChipProps) => {
        ...
        case 'success':
            if (variant === 'outlined') {
                ...
                defaultSX = {
                    ...
                    bgcolor: theme.palette.mode === 'dark' ? theme.palette.success.main : theme.palette.success.light + 60,
                    ':hover': {
                        color: theme.palette.success.light,
