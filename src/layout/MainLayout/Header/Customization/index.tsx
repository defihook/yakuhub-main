...
// assets
import { IconMoon, IconBulb } from '@tabler/icons';
import { HighlightOutlined, CloseCircleOutlined } from '@ant-design/icons';

const Customization = () => {
    const theme = useTheme();
    const { container, fontFamily, mode, presetColor, onChangeMode } = useConfig();
    ...
    const handleModeChange = (value: PaletteMode) => {
        onChangeMode(value);
    };
    ...
    return (
        <>
            ...
            >
                <Tooltip title="Light/Dark Theme Changer">
                    {mode === 'light' ? (
                        <Avatar
                            variant="rounded"
                            sx={{
                                ...
                                <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
                                    <Stack direction="row" spacing={1.25} alignItems="center">
                                        <IconButton
                                            disableRipple
                                            color="secondary"
                                            sx={{ bgcolor: theme.palette.background.default, borderRadius: '.75rem' }}
                                            onClick={handleToggle}
