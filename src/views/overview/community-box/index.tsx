...
import CommunityImg01 from 'assets/images/workspace/solana-icon.png';
import CommunityImg02 from 'assets/images/workspace/staking-icon.png';
...
const CommunityBox = () => (
    <section className="skill-box mb-4">
        <div className="flex items-center mb-3">
            ...
            <button type="button" className="ml-auto mr-2 p-1 bg-transparent">
                <Search sx={{ fontSize: 30 }} className="low-text" />
            </button>
            <button type="button" className="p-1 bg-transparent">
                <AddBoxOutlined sx={{ fontSize: 30 }} className="low-text" />
            </button>
        </div>

        {CommunitiesData.map((el, idx) => (
            <div key={idx} className="community-item flex items-center gap-3 mb-3 text-sm font-medium">
                ...
                <div>
                    ...
                    <p className="low-text flex items-center">
                        <span className="inline-block h-2 w-2 mr-2 rounded-full bg-yellow-300" />
