...
const SpaceCard = ({ space }: SpaceCardProps) => {
    ...
    const { data, loading } = useAuthQuery(queries.GET_SPACE, { variables: { symbol }, fetchPolicy: 'cache-and-network' });
    const [JoinSpace] = useAuthMutation(mutations.JOIN_SPACE);
